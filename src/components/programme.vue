<template>
  <div style="width:100%">
     <div class="navlist">
      ...
      <div class="swiper-container2 swiper_con">
        <div class="swiper-wrapper">
          <!-- 第一个swiper -->
          <div class="swiper-slide" ref="viewBox">
            <div class="lefttext">
              
                <div class="livingroom" v-for="(val, i) in one.hardPlanList" :key="i" v-if="val.width != undefined">
                <!-- <div> -->
                   <div class="imgbox">
                     <img
                      v-if="one.hardPlanList[i].description"
                      :src="one.hardPlanList[i].description" 
                    />
                  </div>
                  <div class="textbox">
                     <span v-if="val">{{one.hardPlanList[i-1].description}}</span>
                     <p v-if="val">{{one.hardPlanList[i-1].description}}</p>
                  </div>
                <!-- </div>   -->
              </div>
              </div>
          ...
          <div class="swiper-slide">
            <div class="righttext">
               <div class="livingroom" v-for="(val, i) in one.softPlanList" :key="i" v-if="val.width != undefined">
                <!-- <div> -->
                   <div class="imgbox">
                     <img
                      v-if="one.softPlanList[i].description"
                      :src="one.softPlanList[i].description" 
                    />
                  </div>
                  <div class="textbox">
                     <span v-if="val">{{one.softPlanList[i-1].description}}</span>
                     <p v-if="val">{{one.softPlanList[i-1].description}}</p>
                  </div>
                <!-- </div>   -->
              </div>
  ...
  created() {
      ...
      this.axios({
        ...
        .then(function(res) {
         ...
         that.one = res.data.data.planList[1];
          // that.two = res.data.data.planList[2];
          // that.three = res.data.data.planList[3];
        })
